...
public enum ErrorCode {
    ...
    UNAUTHORIZED_HEADER_MISSING("AUTH-004", HttpStatus.UNAUTHORIZED,
            "UNAUTHORIZED_HEADER_MISSING"),
    ...
    UNAUTHORIZED_TEAM_MEMBER_PERMISSION_REQUIRED("TEAM-005", HttpStatus.UNAUTHORIZED,
            "UNAUTHORIZED_TEAM_MEMBER_PERMISSION_REQUIRED"),
    BAD_REQUEST_CANNOT_CREATE_TEAM_WITH_EXISTING_TEAM_MEMBER("TEAM-006", HttpStatus.BAD_REQUEST,
            "BAD_REQUEST_CANNOT_CREATE_TEAM_WITH_EXISTING_TEAM_MEMBER"),
    ...
    BAD_REQUEST_INVALID_SUB_TEAM("MATCH-STATS-005", HttpStatus.BAD_REQUEST,
            "BAD_REQUEST_INVALID_SUB_TEAM"),
